...
/// </summary>
public class CustomerSearchQueryValidator : BaseSearchQueryValidator<Customer>
{
    protected override EntityMetadata Metadata => Inventorization.Commerce.Meta.DataModelMetadata.Customer;
}
