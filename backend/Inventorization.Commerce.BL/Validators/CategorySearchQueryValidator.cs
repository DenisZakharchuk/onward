...
/// </summary>
public class CategorySearchQueryValidator : BaseSearchQueryValidator<Category>
{
    protected override EntityMetadata Metadata => Inventorization.Commerce.Meta.DataModelMetadata.Category;
}
