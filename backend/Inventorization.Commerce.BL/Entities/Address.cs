...
namespace Inventorization.Commerce.BL.Entities;

/// <summary>
/// Customer address
/// </summary>
public class Address : OwnedBaseEntity<UserTenantOwnership>
{
    /// <summary>
    ...
    /// Collection of Order
    /// </summary>
    public ICollection<Order> OrdersShippedTo { get; } = new List<Order>(10);
    ...
    /// <summary>
    /// Updates Address with new values
    /// </summary>
    /// <param name="addressType">Address type (Shipping or Billing)</param>
    /// <param name="street">Street address</param>
    /// <param name="city">City</param>
