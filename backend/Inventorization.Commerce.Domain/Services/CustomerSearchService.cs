...
/// <summary>
/// Service for executing ADT-based search queries on Customer entities.
/// Inherits all search logic from BaseSearchService.
/// Supports both regular projections and field transformations.
/// </summary>
public class CustomerSearchService : BaseSearchService<Customer, CustomerProjection>
{
    public CustomerSearchService(
        IRepository<Customer> repository,
        IQueryBuilder<Customer> queryBuilder,
        IProjectionMapper<Customer, CustomerProjection> projectionMapper,
