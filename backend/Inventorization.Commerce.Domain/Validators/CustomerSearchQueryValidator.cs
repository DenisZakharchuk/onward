...
/// <summary>
/// Validates SearchQuery against Customer entity metadata.
/// Ensures field names, operators, and types are valid before query execution.
/// </summary>
public class CustomerSearchQueryValidator : IValidator<SearchQuery>
{
    private static readonly EntityMetadata Metadata = Inventorization.Commerce.Meta.DataModelMetadata.Customer;
    ...
    private void ValidateFilterCondition(FilterCondition condition, List<string> errors)
    {
        ...
        {
            errors.Add($"Field '{condition.FieldName}' does not exist in Customer entity");
            return;
        }
    ...
    private void ValidateProjection(ProjectionRequest projection, List<string> errors)
    {
        foreach (var field in projection.Fields)
        {
            ...
            {
                errors.Add($"Field '{fieldName}' does not exist in Customer entity");
            }
        }
    }
    ...
    private void ValidateSort(SortRequest sort, List<string> errors)
    {
        foreach (var field in sort.Fields)
        {
            ...
            {
                errors.Add($"Sort field '{field.FieldName}' does not exist in Customer entity");
            }
        }
    }
