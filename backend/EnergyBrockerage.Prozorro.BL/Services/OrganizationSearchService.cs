...
/// <summary>
/// Service for executing ADT-based search queries on Organization entities.
/// Inherits all search logic from BaseSearchService.
/// Supports both regular projections and field transformations.
/// </summary>
public class OrganizationSearchService : BaseSearchService<Organization, OrganizationProjection>
{
    public OrganizationSearchService(
        IRepository<Organization> repository,
        IQueryBuilder<Organization> queryBuilder,
        IProjectionMapper<Organization, OrganizationProjection> projectionMapper,
        ProjectionExpressionBuilder expressionBuilder,
        OrganizationSearchQueryValidator validator,
