...
/// <summary>
/// Validates CreateStockLocationDTO
/// </summary>
public class CreateStockLocationValidator : IValidator<CreateStockLocationDTO>
{
    public Task<ValidationResult> ValidateAsync(CreateStockLocationDTO dto, CancellationToken cancellationToken = default)
    {
        if (dto == null)
