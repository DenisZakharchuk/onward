...
/// <summary>
/// Validates UpdatePurchaseOrderDTO
/// </summary>
public class UpdatePurchaseOrderValidator : IValidator<UpdatePurchaseOrderDTO>
{
    public Task<ValidationResult> ValidateAsync(UpdatePurchaseOrderDTO dto, CancellationToken cancellationToken = default)
    {
        if (dto == null)
