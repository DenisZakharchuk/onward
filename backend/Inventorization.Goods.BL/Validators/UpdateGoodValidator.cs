...
/// <summary>
/// Validates UpdateGoodDTO
/// </summary>
public class UpdateGoodValidator : IValidator<UpdateGoodDTO>
{
    public Task<ValidationResult> ValidateAsync(UpdateGoodDTO dto, CancellationToken cancellationToken = default)
    {
        if (dto == null)
