...
/// </summary>
public interface IGoodSupplierDataService : IDataService<GoodSupplier, CreateGoodSupplierDTO, UpdateGoodSupplierDTO, DeleteGoodSupplierDTO, InitGoodSupplierDTO, GoodSupplierDetailsDTO, GoodSupplierSearchDTO>
{
}
