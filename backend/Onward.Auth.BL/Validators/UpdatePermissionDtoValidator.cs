...
namespace Onward.Auth.BL.Validators;

/// <summary>
/// Validates UpdatePermissionDTO for permission updates
/// </summary>
public class UpdatePermissionDtoValidator : IValidator<UpdatePermissionDTO>
{
    /// <summary>
    /// Validates permission update data
    /// </summary>
    public async Task<ValidationResult> ValidateAsync(UpdatePermissionDTO dto, CancellationToken cancellationToken = default)
    {
        if (dto == null)
